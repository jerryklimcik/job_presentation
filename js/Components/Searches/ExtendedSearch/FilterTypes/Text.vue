<template>
    <div class="form-group">
        ...
        <div class="form-group">
            <input type="text" v-show="showInput" class="form-control input-sm extended-search-form-input"
...
<script>
    export default {
        ...
        watch: {
            filterData: function () {
                this.internalText = (this.filterData.text && this.filterData.hasFilter !== undefined) ? this.filterData.text : '';
                this.internalOperator = (this.filterData.operator && this.filterData.hasFilter !== undefined) ? this.filterData.operator : 'like';
            }
        },
        data: function () {
            return {
