...
<script>
    ...
    export default {
        ...
        data: function () {
            return {
                internalText: (this.filterData.text && this.filterData.hasFilter !== undefined) ? moment(this.filterData.text, 'YYYY-MM-DD').format('DD.MM.YYYY') : '',
        ...
        methods: {
            changeText: function () {
                this.$emit('updateText', moment(this.internalText, this.dateFormat).format('YYYY-MM-DD'));
            },
